class TranslaterLogic {
  static const int _nVowels = 26;

  final List<String> vowelsUni = List.filled(_nVowels, '');
  final List<String> vowels = List.filled(_nVowels, '');
  final List<String> vowelModifiersUni = List.filled(_nVowels, '');
  final List<String> specialConsonants = List.filled(6, '');
  final List<String> specialConsonantsUni = List.filled(6, '');
  final List<String> consonants = List.filled(46, '');
  final List<String> consonantsUni = List.filled(46, '');
  final List<String> specialCharUni = List.filled(2, '');
  final List<String> specialChar = List.filled(2, '');
